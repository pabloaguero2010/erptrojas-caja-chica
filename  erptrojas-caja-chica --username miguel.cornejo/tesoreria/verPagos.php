<table width="687" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="436"><p><strong>Ver pagos</strong> </p>
              <p>Seleccione la fecha de pagos</p></td>
            <td width="27">&nbsp;</td>
           	
            <td width="148"><label></label></td>
...
?></td>
			...
			$ssql2 =  "select distinct on (date_part('Year',fecha)) date_part('Year',fecha) as ano from pago;";
		...
		?>
            ...
            <td class="textoform">&nbsp;</td>
            <td class="textoform"><input type="hidden" name="flag" value="3" />

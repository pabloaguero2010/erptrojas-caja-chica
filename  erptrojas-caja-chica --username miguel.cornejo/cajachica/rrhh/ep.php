...
$sql = "SELECT rut_proveedor, nombre_proveedor, telefono_proveedor, mail_proveedor, web_proveedor FROM proveedor WHERE ".$cn."AND".$cg."AND".$cd." limit ". $TAMANO_PAGINA." offset " . $inicio;
...
?>
        ...
        <table width="687" border="0" cellspacing="0" cellpadding="0">
          ...
          <form  id="aif" name="aif" action="rrhh.php?op=ep" method="post">
          <tr>
            <td height="30">&nbsp;</td>
           ...
           <div id="tabla">
            <table width="657" border="0" cellspacing="0" cellpadding="0" id="tablasort" class="to">
			  ...
			  if ($i%2==0)
               ...
               echo "<td><a href='rrhh.php?op=ep2&cod=".$rut."' >".$nombre."</a></td>";
               echo "<td><a href='rrhh.php?op=ep2&cod=".$rut."' >".$fono."</a></td>";
               echo "<td><a href='rrhh.php?op=ep2&cod=".$rut."' >".$mail."</a></td>";
               echo "<td><a href='rrhh.php?op=ep2&cod=".$rut."' >".$web."</a></td>";
...
?>
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><a href="rrhh.php?op=ep&pagina=1"><img src="../tablesorter/icons/first.png" width="16" height="16"></a></td>
                <td><a href="rrhh.php?op=ep&pagina=<?php echo $prev; ?>"><img src="../tablesorter/icons/prev.png" width="16" height="16"></a></td>
                <td align="center" valign="middle">&nbsp;<?php echo $pagina; ?>&nbsp;</td>
                <td><a href="rrhh.php?op=ep&pagina=<?php echo $next; ?>"><img src="../tablesorter/icons/next.png" width="16" height="16"></a></td>
                <td><a href="rrhh.php?op=ep&pagina=<?php echo $total_paginas; ?>"><img src="../tablesorter/icons/last.png" width="16" height="16"></a></td>
              </tr>
            </table>
<?php
} 

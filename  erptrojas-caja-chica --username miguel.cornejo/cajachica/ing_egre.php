...
$sql3 = "select to_char(fecha, 'mm') as fecha2,fecha  from caja_chica order by id_caja desc limit 1";
//echo"consulta:".$sql3;
...
?>
<form name="formulario" method="post" action="cajachica.php">
            ...
            <td colspan="6"><strong> </strong>
              <table width="461" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="406"><p><strong>Movimientos  <?php 

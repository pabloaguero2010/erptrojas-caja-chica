...
if ($valnt=$_GET["ok"]==1)
	...
	$saldoact=$_GET["saldo"];
	if($warning) $warning=$warning." <br> ";
	$warning=$warning."Se ingresaron/actualizaron los datos correctamente <br> el saldo actual es de: $ ".$_GET["saldo"];
	}
if ($valnt=$_GET["ok"]==2)
	{
	if($warning) $warning=$warning." <br> ";
...
if ($valnt=$_GET["ok"]==3)
	{
	if($warning) $warning=$warning." <br> ";
	$warning=$warning."Se ingresaron/actualizaron los datos correctamente <br> El monto ingresado fue de: $ ".$_GET["saldo"];
	}
...
<link rel="stylesheet" href="tesoreria.css" type="text/css" />
...
?>
  ...
  <table width="955" height="450" border="0" cellpadding="0" cellspacing="0">
    <tr valign="top">
      <td height="39" colspan="2"><img src="../images/tesoreria.png" width="955" height="39" /></td>
     </tr>
     <tr valign="top">
      <td width="268" height="100%" background="../images/bglogin.png" align="center"><p><br />
	    ...
	    <ul id="nav">
			...
			<li><a href="tesoreria.php?op=gc">Gestión de Facturas </a>
				<ul>
                  <li><a href="tesoreria.php?op=ie">Ingresar Facturas</a></li>
                  <li><a href="tesoreria.php?op=pp">Ver Facturas</a></li>
				</ul>
			</li>	
		    <li><a href="#">Gestión de Pagos</a>
                <ul>
                  <li><a href="tesoreria.php?op=ip">Ingresar Pagos</a></li>
                  <li><a href="tesoreria.php?op=vp">Ver Pagos</a></li>
			    </ul>
	      </li>
			<li><a href="#">Gestión de Caja Chica</a>
                <ul>
                  <li><a href="tesoreria.php?op=gc">Ingresos de Fondos </a></li>
                  <li><a href="tesoreria.php?op=rf">Rendición de Fondos</a></li>
				  <li><a href="tesoreria.php?op=pp">Informe Mensual</a></li>
			    </ul>
	      </li>
      ...
      <td width="687" bgcolor="#FFFFFF"> <div id="advertencia" class="msjerror" align="center"> <?php echo $warning; ?> </div>
        <p>
		  ...
		  if ($menu=="gc")
		  	{
			include("In_tesoreria.php");
			}
			elseif ($menu=="rf")
		  	{
			include("rend_tesoreria.php");
			}
			elseif ($menu=="pp")
		  	{
			include("informes_IR.php");
			}
			elseif ($menu=="ip")
		  	{
			include("ingreso_pag.php");
			}
			elseif ($menu=="ei")
		  	{
			include("edit_IR.php");

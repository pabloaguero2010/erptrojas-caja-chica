...
$ssql =  "select * from rendicion_tesoreria where date_part('month',fecha) = $mes_sel and date_part('Year',fecha)=$ano and tipo ='$informe'";
//echo"consulta:".$ssql;
...
$sql3 = "select sum(total) as total  from rendicion_tesoreria where date_part('month',fecha) = $mes_sel and date_part('Year',fecha)=$ano and tipo ='$informe'";
//echo"consulta:".$sql3;
           ...
           <div id="tabla">
            <table width="657" border="0" cellspacing="0" cellpadding="0" id="tablasort" class="to">
			 ...
			 if ($i%2==0)
               ...
               echo "<td><a href='tesoreria.php?op=ei&cod=".$cod."' >".$fecha."</a></td>";
               echo "<td><a href='tesoreria.php?op=ei&cod=".$cod."' >".$concepto."</a></td>";
               echo "<td><a href='tesoreria.php?op=ei&cod=".$cod."' >".$responsable."</a></td>";
               echo "<td><a href='tesoreria.php?op=ei&cod=".$cod."' >".$saldo."</a></td>";

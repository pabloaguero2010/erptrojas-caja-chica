 ...
 * @version     SVN: $Id: shadowbox.js 104 2008-06-28 20:09:34Z mjijackson $
 */
...
(function(){
    ...
    var toggleLoading = function(on, cb){
        ...
        if(on){
            ...
            if(anim){
                animate(loading, 'opacity', 0, 0.35, fn);
            }else{
                fn();
            }
        }
     ...
     * @private
     */
    var toggleVisible = function(on){
        var els, v = on ? 'hidden' : 'visible';
        ...
        if(on){
            ...
            animate(so, 'opacity', 0, 0.2, function(){
    ...
    Shadowbox.init = function(opts){
        ...
        SL.append(document.body, markup);

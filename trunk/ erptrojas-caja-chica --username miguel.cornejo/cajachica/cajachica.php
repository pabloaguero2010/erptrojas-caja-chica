...
<link rel="stylesheet" href="cajachica.css" type="text/css" />
...
?>
  ...
  <table width="955" height="450" border="0" cellpadding="0" cellspacing="0">
    <tr valign="top">
      <td height="39" colspan="2"><img src="../images/titulo cajachica.png" width="955" height="39" /></td>
     </tr>
     <tr valign="top">
      <td width="268" height="100%" background="../images/bglogin.png" align="center"><p><br />
	    ...
	    <ul id="nav">
			...
			<li><a href="cajachica.php?op=gc">Ingresos/Egresos</a></li>
            <li><a href="cajachica.php?op=aie">Anular Ingresos/Egresos</a></li>
            <li><a href="cajachica.php?op=vr">Ver Responsables de Ingresos/Egresos</a></li>
		    <li><a href="#">Informes</a>
                <ul>
                  <li><a href="cajachica.php?op=ie">Por Mes</a></li>
                  <li><a href="cajachica.php?op=pp">Por Proveedor</a></li>
                </ul>
	      </li>
      ...
      <td width="687" bgcolor="#FFFFFF"> <div id="advertencia" class="msjerror" align="center"> <?php echo $warning; ?> </div>
        <p>
		  ...
		  if ($menu=="gc")
		  	{
			include("gCaja_chica.php");
			}
			elseif ($menu=="ie")
		  	{
			include("ing_egre.php");
			}
			elseif ($menu=="aie")
		  	{
			include("a_ing_egre.php");
			}
			elseif ($menu=="vr")
		  	{
			include("vr.php");
			...
			elseif ($menu=="ec")
		  	{
			include("editCaja.php");
			}
			elseif ($menu=="pp")
		  	{
			include("editCajap.php");
			}
			elseif ($menu2=="2")
		  	{
			include("editCajap.php");

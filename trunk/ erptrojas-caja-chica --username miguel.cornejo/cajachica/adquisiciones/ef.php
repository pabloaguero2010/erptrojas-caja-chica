...
?>
        ...
        <table width="687" border="0" cellspacing="0" cellpadding="0">
          ...
          <form  id="aif" name="aif" action="adquisiciones.php?op=ef" method="post">
          <tr>
            <td height="30">&nbsp;</td>
           ...
           <div id="tabla">
            <table width="657" border="0" cellspacing="0" cellpadding="0" id="tablasort" class="to">
			  ...
			  if ($i%2==0)
               ...
               echo "<td><a href='adquisiciones.php?op=ef2&cod=".$cod."' >".$fecha."</a></td>";
               echo "<td><a href='adquisiciones.php?op=ef2&cod=".$cod."' >".$proveedor."</a></td>";
               echo "<td><a href='adquisiciones.php?op=ef2&cod=".$cod."' >".$descripcion."</a></td>";
               echo "<td><a href='adquisiciones.php?op=ef2&cod=".$cod."' >".$total."</a></td>";
               if ($entregado=='1')
			    echo "<td><a href='adquisiciones.php?op=ef2&cod=".$cod."' ><img src='../images/check.png' width='15' height='15'/></a></td>";
			   else
				echo "<td>&nbsp;</td>";
			   if ($pagado=='1')
			    echo "<td><a href='adquisiciones.php?op=ef2&cod=".$cod."' ><img src='../images/check.png' width='15' height='15'/></a></td>";
...
?>
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><a href="adquisiciones.php?op=ef&pagina=1"><img src="../tablesorter/icons/first.png" width="16" height="16"></a></td>
                <td><a href="adquisiciones.php?op=ef&pagina=<?php echo $prev; ?>"><img src="../tablesorter/icons/prev.png" width="16" height="16"></a></td>
                <td align="center" valign="middle">&nbsp;<?php echo $pagina; ?>&nbsp;</td>
                <td><a href="adquisiciones.php?op=ef&pagina=<?php echo $next; ?>"><img src="../tablesorter/icons/next.png" width="16" height="16"></a></td>
                <td><a href="adquisiciones.php?op=ef&pagina=<?php echo $total_paginas; ?>"><img src="../tablesorter/icons/last.png" width="16" height="16"></a></td>
              </tr>
            </table>
<?php
} 

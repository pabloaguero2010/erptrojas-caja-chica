...
<form  id="aif" name="aif" action="rend_tesoreria2.php" method="post">
        <table width="687" border="0" cellspacing="0" cellpadding="0">
            ...
            <td colspan="6"><strong> </strong>
              <table width="456" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="401"><strong> Rendicion de fondos a caja chica </strong></td>
                </tr>
              </table>            </td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td class="textoform"><label>
              <input name="concepto" type="text" class="validate['required']" id="concepto"  size="35" />
            </label></td>
            <td class="textoform">&nbsp;</td>
            <td class="textoform">&nbsp;</td>
          ...
          <tr>
            ...
            <td class="textoform">:</td>
            <td class="textoform"><label>$
                <input class="validate['digit']" type="text" name="ingreso" id="ingreso" />
            </label></td>
            <td class="textoform">&nbsp;</td>
            <td class="textoform">&nbsp;</td>
            <td class="textoform">&nbsp;</td>

...
if($val)
	{
	header("location: operaciones.php?op=sis".$campos.$val);
	}
else
	{
...
<form  id="aif" name="aif" action="sis3.php?<?php echo "cliente=".$cliente."&fecha=".$fecha."&tv=".$tv."&ruta=".$ruta."&ts=".$ts."&sd=".$sd."&sp=".$sp."&es=".$es."&dm=".$dm."&se=".$se."&dias=".$dias."&prov=".$prov."&desc=".$desc."&ot=".$ot."&gd=".$gd."&oc=".$oc; ?>" method="post">
            ...
            <td colspan="6"><strong> </strong>
              <table width="456" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="401"><strong> Prestación de Servicios sin Estado de Pago.</strong></td>
                </tr>
              </table>            </td>
            <td>&nbsp;</td>
          </tr>
...
?>
          ...
          <tr>
            <td height="30">&nbsp;</td>
            <td class="textoform">Valor Total</td>
            <td class="textoform">:</td>
            <td class="textoform"><label> 
          ...
          <tr>
            ...
            <td valign="middle">
              <div align="right">
                <input name="anterior" type="button" class="botonlogin" id="anterior" value="Anterior" onclick='gotoLink("operaciones.php?op=sis")' />
              </div></td>
